...
[
  ...
  sys-avg-cpu-utilization
  sys-avg-mem-utilization
  sys-avg-net-utilization
]
...
to go
  ...
  set sys-avg-cpu-utilization sys-avg-cpu-utilization + ((count a-svrs) / (count servers)) * (sum [ops-now + ops-rsv] of servers / sum [ops-phy] of servers)
  set sys-avg-mem-utilization sys-avg-mem-utilization + ((count a-svrs) / (count servers)) * (sum [mem-now + mem-rsv] of servers / sum [mem-phy] of servers)
  set sys-avg-net-utilization sys-avg-net-utilization + ((count a-svrs) / (count servers)) * (sum [net-now + net-rsv] of servers / sum [net-phy] of servers)
...
to print-summary
  ...
  print (word "| Avg CPU utilization                                 : " (precision exp-avg-cpu-usage 4))
  print (word "| Avg MEM utilization                                 : " (precision exp-avg-mem-usage 4))
  print (word "| Avg NET utilization                                 : " (precision exp-avg-net-usage 4))
  print "==Summary of Results =========================================================="
end
;;############################################################################;;
...
to-report exp-avg-cpu-usage
  report sys-avg-cpu-utilization / ticks
end
to-report exp-avg-mem-usage
  report sys-avg-mem-utilization / ticks
end
to-report exp-avg-net-usage
  report sys-avg-net-utilization / ticks
end
@#$#@#$#@
GRAPHICS-WINDOW
345
...
2078
1125
Avg Resource Utilization(Datacenter)
Time
Utils (%)
0.0
10.0
...
"" ""
PENS
"NET" 1.0 0 -11033397 true "" "let a-svrs servers with [status = \"ON\" or status = \"OVERLOAD\"]\nlet p-value 0\nif count a-svrs > 0\n[set p-value ((count a-svrs) / (count servers)) * (sum [net-now + net-rsv] of servers / sum [net-phy] of servers)]\nplot p-value * 100"
"MEM" 1.0 0 -8630108 true "" "let a-svrs servers with [status = \"ON\" or status = \"OVERLOAD\"]\nlet p-value 0\nif count a-svrs > 0\n[set p-value ((count a-svrs) / (count servers)) * (sum [mem-now + mem-rsv] of servers / sum [mem-phy] of servers)]\nplot p-value * 100"
"CPU" 1.0 0 -2674135 true "" "let a-svrs servers with [status = \"ON\" or status = \"OVERLOAD\"]\nlet p-value 0\nif count a-svrs > 0\n[set p-value ((count a-svrs) / (count servers)) * (sum [ops-now + ops-rsv] of servers / sum [ops-phy] of servers)]\nplot p-value * 100"
